...
import CandidateCandidates from "./components/Candidate/candidates/Candidates";
...
import ClientClients from "./components/Client/clients/Clients";
...
const EmployeeLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      {/* Sidebar */}
      <div
        className={`h-full flex flex-col bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 ${
      ...
      <Router>
        <Routes>
          ...
          <Route path="/candidate" element={<CandidateLayout />}>
            ...
            <Route
              path="candidates/:id"
              element={<CandidateCandidateDetails />}
            />
