...
const Employees = () => {
          ...
          if (response.data.success) {
            ...
            formsData.forEach((form) => {
              ...
              if (!recipient) {
                ...
                const validCompletedFields = recipient.completedFields.filter(
                  (field) => {
  ...
  const confirmDelete = async () => {
    try {
      ...
      if (response.data.deletedFromEmployee && response.data.deletedFromUser) {
        setSuccessMsg(
          `${message} (deleted from both Employee and User records)`
        );
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMsg(
        "Employee created successfully! Credentials have been sent via email."
      );
      setShowForm(false);
      setFormData({
        firstName: "",
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 lg:py-8 space-y-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <div className="bg-white rounded-3xl p-2 text-black">
              <FiPlus className="h-5 w-5 text-black" />
            </div>
            Add New Employee
          </button>
        </div>
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        ...
                        {selectedEmployee?.lastName}? This action cannot be
                        undone.
                      </p>
                    </div>
                  </div>
